...
{
      17,     0,    -1,    -1,    17,    18,    -1,    19,    -1,     3,
      -1,     4,    -1,     5,    -1,     6,    -1,     7,    -1,    19,
      10,    19,    -1,    19,    11,    19,    -1,    19,    12,    19,
      -1,    19,    13,    19,    -1,    19,     9,    19,    -1,    14,
      19,    15,    -1
};
...
{
  "$end", "error", "$undefined", "INTEGER", "FLOAT", "STRING", "FIELD",
  "SPECIAL", "FUNCTION", "'&'", "'+'", "'-'", "'*'", "'/'", "'('", "')'",
  "$accept", "input", "string", "exp", 0
};
#endif
...
{
     -12,     0,   -12,   -12,   -12,   -12,   -12,   -12,     5,   -12,
      23,    16,     5,     5,     5,     5,     5,   -12,    27,    30,
     -11,     2,   -12
};
...
{
       2,    15,    16,     3,     4,     5,     6,     7,     3,     4,
       5,     6,     7,     0,     8,    16,    11,     0,     0,     8,
      18,    19,    20,    21,    22,    12,    13,    14,    15,    16,
       0,    17,    12,    13,    14,    15,    16,    13,    14,    15,
      16,    14,    15,    16
};
...
static const yytype_int8 yycheck[] =
{
       ...
       5,     6,     7,    -1,    14,    13,     8,    -1,    -1,    14,
      12,    13,    14,    15,    16,     9,    10,    11,    12,    13,
      -1,    15,     9,    10,    11,    12,    13,    10,    11,    12,
      13,    11,    12,    13
};
